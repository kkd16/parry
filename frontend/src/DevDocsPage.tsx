  ...
  return (
    <>
      ...
      <div className="rounded-md border border-rule bg-bg-raised px-3 pt-4 pb-3.5">
        ...
        >
          ...
          {edges.map(({ edge, geo, planned }) => (
            <g key={`${edge.from}-${edge.to}`}>
              ...
              {geo.label && (
                <text
                  className="fill-ink-mute text-[9px] tracking-wider uppercase"
                  x={geo.label.x}
                  y={geo.label.y}
                  textAnchor="middle"
                >
          ...
          {placed.map((n) => (
            ...
            >
              ...
              <text
                className="fill-ink-mute text-[9.5px] tracking-wider"
                x={n.cx}
                y={n.y + 45}
                textAnchor="middle"
              >
              ...
              {n.status === "planned" && (
                <g>
                  ...
                  />
                  <text
                    className="fill-brass text-[8px] tracking-widest uppercase"
                    x={n.x + n.w - 30}
                    y={n.y + 3}
                    textAnchor="middle"
                  >
        ...
        <div className="mt-2.5 flex flex-wrap gap-4.5 border-t border-dashed border-rule-soft px-2.5 pt-2 text-micro tracking-widest text-ink-dim uppercase">
